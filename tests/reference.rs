...
fn valid_references() {
  ...
  for t in &[
    ...
    Tcase {
      input: "busybox@sha256:ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff",
      ..Default::default()
    },
    Tcase {
...
fn hostname_without_namespace() {
  let dkr_ref =
    Reference::from_str("sat-r220-02.lab.eng.rdu2.redhat.com:5000/default_organization-custom-ocp").unwrap();

  assert_eq!(dkr_ref.registry(), "sat-r220-02.lab.eng.rdu2.redhat.com:5000");
